...
const segemntAI = () => extend(AIController, {
    updateMovement() {
        this.unloadPayloads();
        //check segment
        const {
...
function segment(name, type, constructor) {
    ...
    Object.assign(unit, {
        // 节单位只能由节ai控制
        aiController: segemntAI, // 排除rts控制
        logicControllable: false, // 排除逻辑控制
        playerControllable: false, // 排除玩家控制
    });
